// Worked with Erin TA , and classmates to compelte this assignment.
// "The Plan"
...
// Use d3 to select the panel with id of `#sample-metadata` found in index.html
...
title: `Sample ID`
    ...
    y:data.samples[0].sample_value,
    mode: 'markers',
    marker: { 
    color:data.samples[0].otu_ids,
    size: data.samples[0].sample_value
    }
}
...
var sample_value = result2.sample_values;
